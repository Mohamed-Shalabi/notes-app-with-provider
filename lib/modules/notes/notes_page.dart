...
class NotesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<NotesPageProvider>(
      builder: (context, notesPageProvider, _) => notesPageProvider.noteModels.isEmpty
          ? Center(child: Text('no notes yet', style: TextStyles.subHeadingStyle))
          : ListView(
              children: List.generate(
                notesPageProvider.noteModels.length,
                (index) {
                  final note = notesPageProvider.noteModels[index];
                  return Padding(
